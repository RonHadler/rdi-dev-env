...
- New MCP tools, services, or models
- New API routes or custom endpoints
- Config or validation changes
- Bug fixes (write a test that reproduces the bug first)

### What can skip writing tests first
- Documentation-only changes
- Config/environment changes (`.env` files, `pyproject.toml` metadata)
...
**Direct Commit to develop (exception, not the rule):**
- Documentation-only changes
